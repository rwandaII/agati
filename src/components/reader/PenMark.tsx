 ...
 *
 * The point of a mark is to be seen on the way past: you should know where you
 * stopped before you have finished reading the first line. So it sits at the
 * line, not at the top of the page, in the outer margin where it covers no
 * words — and it finds that line again by measuring the laid-out text, which is
 * the only thing that knows where a character ended up on this screen.
 */
